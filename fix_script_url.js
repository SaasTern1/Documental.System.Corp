...
const sendTarget = `window.sendNotification = async (dest, sub, msg) => { 
...
const sendRepl = `window.sendNotification = async (dest, sub, msg) => { 
...
// Replace handling special cases for newlines
content = content.replace(sendTarget, sendRepl).replace(sendTarget.replace(/\r\n/g, '\n'), sendRepl);

fs.writeFileSync('app.js', content);
console.log('Replaced window.sendNotification');
