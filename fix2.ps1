...
$startStr = '<label for="fb-tipo-campo">Tipo de Campo</label>'
$endStr = '<!-- Modal for Viewing Form Responses -->'
...
"@
    ...
    Write-Host "Success! The file has been fixed."
} else {
    Write-Host "Target not found. Please check index.html."
